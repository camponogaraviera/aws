...
- [3. Application Architecture Layer](#architecture)
  ...
  - Backend & APIs
    ...
    - Amazon API Gateway
    - AWS AppSync for GraphQL and WebSockets
...
- [7. Technical Interview](#interview)
...
- [AWS AppSync for GraphQL and WebSockets](architecture/backend_apis/appsync.md)
...
<!-- #region Technical Interview -->
<details>
  <summary><h1 id="interview">7. Technical Interview</h1></summary>
