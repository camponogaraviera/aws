...
Suitable for connecting the frontend of static websites (Angular, ReactJS, Next.js, or Vue.js/Nuxt.js) and mobile applications (kotlin, swift, flutter, react-native) with the backend. Provides SSL/TLS certificate (HTTPS). CloudFront is used as a caching layer, and S3 as a disk storage.
